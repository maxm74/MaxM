...
//
//MaxM
//    Lazarus Porting Incompleto
//
//TO-DO write a CopyFile with Callback like Windows CopyFileEX.........
//       do not use TModalResult and MessageDlg in this File.
//      FileVersion in Linux?

unit MM_CopyRoutines;

interface
uses SysUtils, Masks, Forms;
...
const
    ...
    { Define possible return codes from the CopyPath callback routine }
    PROGRESS_CONTINUE = 0;
    PROGRESS_CANCEL = 1;
    PROGRESS_STOP = 2;
    PROGRESS_QUIET = 3;
...
type
  ...
  TCopyProgressRoutine = function (
    ...
    StreamBytesTransferred : ValUInt;           // total number of bytes transferred for this stream
...
Var
   ...
   begin
        Result :=MessageDlg('Overwrite EXISTING File :'+#13#10#13#10+
                            ...
                            mtConfirmation, [mbYes, mbNo, mbYesToAll, mbNoToAll, mbCancel], 0);
   end;
